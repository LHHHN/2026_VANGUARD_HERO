...
typedef struct
{
    ...
    CAN_instance_t *motor_can_instance;    // 超电注册到 CAN 服务后的实例
    super_cap_callback_t receive_data;     // 最近一次收到的状态帧
    super_cap_fillmessage_t transmit_data; // 下一次待发送的控制帧内容
