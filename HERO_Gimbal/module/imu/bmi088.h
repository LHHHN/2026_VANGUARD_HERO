...
#define GYRO_X_OFFSET -0.000724180834f//0.00209004059f
#define GYRO_Y_OFFSET 0.00332691544f//0.00036589574f
#define GYRO_Z_OFFSET 0.000454180234f//0.00065642950f
#define ACCEL_X_OFFSET -0.309201628f//0.0859197676f
#define ACCEL_Y_OFFSET 0.486566007f//0.130492121f
#define ACCEL_Z_OFFSET 0.0f
#define G_NORM 9.8018931f // 重力加速度
// 陀螺仪默认环境温度
