...
static Graph_Data_t UI_shoot_crosshair[5];
static Graph_Data_t UI_shoot_center[7];
...
static void UI_State_Data(void)
{

  UI_Char_Draw(&UI_State_sta[6],
	     "ss6",
	     UI_Graph_ADD,
	     8,
	     UI_Color_Main,
	     ...
	     800,
	     "control:");
  UI_Char_Refresh(&referee_recv_info->referee_id, UI_State_sta[6]);
  // 绘制车辆状态标志指示
  UI_Char_Draw(&UI_State_sta[0],
	     "ss0",
	     UI_Graph_ADD,
	     8,
	     UI_Color_Main,
	     ...
	     750,
	     "chassis:");
  UI_Char_Refresh(&referee_recv_info->referee_id, UI_State_sta[0]);
  UI_Char_Draw(&UI_State_sta[1],
	     "ss1",
	     UI_Graph_ADD,
	     8,
	     UI_Color_Yellow,
	     ...
	     700,
	     "gimbal:");
  UI_Char_Refresh(&referee_recv_info->referee_id, UI_State_sta[1]);
  UI_Char_Draw(&UI_State_sta[2],
	     "ss2",
	     UI_Graph_ADD,
	     8,
	     UI_Color_Orange,
	     ...
	     650,
	     "shoot:");
  UI_Char_Refresh(&referee_recv_info->referee_id, UI_State_sta[2]);
  UI_Char_Draw(&UI_State_sta[3],
	     "ss3",
	     UI_Graph_ADD,
	     8,
	     ...
	     600,
	     "frict:");
  UI_Char_Refresh(&referee_recv_info->referee_id, UI_State_sta[3]);
  UI_Char_Draw(&UI_State_sta[4],
	     "ss4",
	     UI_Graph_ADD,
	     8,
	     UI_Color_Purplish_red,
	     ...
	     550,
	     "ammo:");
  UI_Char_Refresh(&referee_recv_info->referee_id, UI_State_sta[4]);

  UI_Char_Draw(&UI_State_dyn[6],
	     "sd6",
	     UI_Graph_ADD,
	     8,
	     UI_Color_Main,
	     ...
	     800,
	     "none");
  UI_Char_Refresh(&referee_recv_info->referee_id, UI_State_dyn[6]);
  // 绘制车辆状态标志，动态
  // 由于初始化时xxx_last_mode默认为0，所以此处对应UI也应该设为0时对应的UI，防止模式不变的情况下无法置位flag，导致UI无法刷新
  UI_Char_Draw(&UI_State_dyn[0],
	     "sd0",
	     UI_Graph_ADD,
	     8,
	     UI_Color_Main,
	     ...
	     750,
	     "stop");
  UI_Char_Refresh(&referee_recv_info->referee_id, UI_State_dyn[0]);
  UI_Char_Draw(&UI_State_dyn[1],
	     "sd1",
	     UI_Graph_ADD,
	     8,
	     UI_Color_Yellow,
	     ...
	     700,
	     "stop");
  UI_Char_Refresh(&referee_recv_info->referee_id, UI_State_dyn[1]);
  UI_Char_Draw(&UI_State_dyn[2],
	     "sd2",
	     UI_Graph_ADD,
	     8,
	     UI_Color_Orange,
	     ...
	     650,
	     "off");
  UI_Char_Refresh(&referee_recv_info->referee_id, UI_State_dyn[2]);
  UI_Char_Draw(&UI_State_dyn[3],
	     "sd3",
	     UI_Graph_ADD,
	     8,
	     UI_Color_Pink,
	     ...
	     600,
	     "off");
  UI_Char_Refresh(&referee_recv_info->referee_id, UI_State_dyn[3]);
  UI_Char_Draw(&UI_State_dyn[4],
	     "sd4",
	     UI_Graph_ADD,
	     8,
	     UI_Color_Pink,
	     ...
	     550,
	     "close");
  UI_Char_Refresh(&referee_recv_info->referee_id, UI_State_dyn[4]);
}

static void UI_Chassis_Limit(void)
{
  // 底盘功率显示，静态
  UI_Char_Draw(&UI_State_sta[5],
	     "ss5",
	     UI_Graph_ADD,
	     7,
	     UI_Color_Green,
	     ...
	     230,
	     "BUFF :");
  UI_Char_Refresh(&referee_recv_info->referee_id, UI_State_sta[5]);
  // 能量条框
...
static void UI_Logo_Sign(void)
{
  ...
  UI_Float_Draw(&UI_Energy[11],
	      ...
	      1440,
	      860,
	      0);//super_cap->receive_data.capEnergy * 1000);
  UI_Graph_Refresh(&referee_recv_info->referee_id, 1, UI_Energy[11]);
  ...
  UI_Float_Draw(&UI_Energy[12],
	      ...
	      1480,
	      620,
	      0);//chassis_cmd.omega_z_now * 100000);
  UI_Graph_Refresh(&referee_recv_info->referee_id, 1, UI_Energy[12]);
...

{
  ...
  UI_Line_Draw(&UI_shoot_arrow[9],
	     ...
	     960,
	     100);
  UI_Line_Draw(&UI_shoot_arrow[10],
	     "sv0",
	     UI_Graph_ADD,
	     9,
	     UI_Color_Cyan,
	     ...
	     960,
	     125);
  UI_Line_Draw(&UI_shoot_arrow[11],
	     "sv1",
	     UI_Graph_ADD,
	     9,
	     UI_Color_Cyan,
	     ...
	     960,
	     125);
  UI_Line_Draw(&UI_shoot_arrow[12],
	     "sv2",
	     UI_Graph_ADD,
	     9,
	     UI_Color_Green,
	     ...
	     960,
	     150);
  UI_Line_Draw(&UI_shoot_arrow[13],
	     "sv3",
	     UI_Graph_ADD,
	     9,
	     UI_Color_Green,
			...
			Referee_Interactive_info_t *_Interactive_data)
{
  ...
  if ((refresh_cnt % 3) == 0)
  {
    ...
    UI_Line_Draw(&UI_measure_digital[1],
	       ...
	       1540,
	       870,
	       0,//1540 + super_cap->receive_data.capEnergy,
	       870);
    UI_Graph_Refresh(&referee_recv_info->referee_id,
		   2,
